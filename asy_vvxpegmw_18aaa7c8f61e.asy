...
real curve(real x){
return .05746*x + 0.87;  //change to the equation for your curve
}
...
real xSubtickSpacing = 10; //set to xTickSpacing if you don't want little ticks
real yTickSpacing = 2;
real ySubtickSpacing = 1;
