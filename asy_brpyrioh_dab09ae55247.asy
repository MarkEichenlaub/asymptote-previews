...
draw((-.02,1.75)--(-.5,1.75), arrow = Arrow(6), red+linewidth(2pt));
label("$\vec{F}_P$",(-.25,1.75),N,red);

real l = 1.5;
draw(shift(.6,0)*((0,0)--(0,.6*l)), arrow = Arrow(6), red);
draw(shift(2.4,0)*((0,0)--(0,.2*l)), arrow = Arrow(6), red);