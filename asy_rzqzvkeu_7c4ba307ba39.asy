...
label(pic,"$\vec{T}$",interp((.5,0),(0,.8-.8*x),.25/(.8-.8*x)),SW,red);
draw(pic,(.5,0)--(.5,.5), red+dotted);
label(pic,"$T_\perp$",(.5,.25),E,red);
draw(pic,(.5,.5)--interp((.5,0),(0,.8-.8*x),.5/(.8-.8*x)), red+dotted);
label(pic,"$T_\parallel$",(.5,.5)/2 + interp((.5,0),(0,.8-.8*x),.5/(.8-.8*x))/2,N,red);
