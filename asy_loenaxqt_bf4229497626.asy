...
return x^(1/2); //change to, e.g. "return x^2;" to plot x^2 on the horizontal axis. 
}
...
string xAxisLabel = "$a^{1/2} \;\; (\mathrm{au}^{1/2})$";
string yAxisLabel = "$T^{1/3} \;\; (\mathrm{days}^{1/3})$";
...
//axes
real xTickSpacing = 0.5; //must be entered as a decimal
real xSubtickSpacing = 0.1; //set equal to xTickSpacing if you don't want little ticks
real yTickSpacing = 4.0;
real ySubtickSpacing = 1.0;
