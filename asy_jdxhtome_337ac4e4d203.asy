...
//box
filldraw(shift(box_bot_left)*rotate(-theta)*scale(.2)*box, lightgray);
...
//angle marker for gravity vector

draw(arc(box_center+(0,-.5),.15,90-theta,90),blue);
label("$\theta$",box_center+(0,-.5)+dir(75)*.14,N,blue);
