//TeXeR source: https://artofproblemsolving.com/texer/wsndlerx
...
draw((0, 2*sqrt(3)/3, -sqrt(6)/6)--(0, 0, -sqrt(6)/6), 0.8*green);
draw((0, 0, sqrt(6)/2)--(0, 0, -sqrt(6)/6), gray(0.6)+linetype("4 4"));
