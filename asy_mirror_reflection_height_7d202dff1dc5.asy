...
pen labelPen       = fontsize(25pt);  // segment labels
...
real labelX    = segX - 0.2;      // label position
...
if (showLabels) {
label("mirror", (0, mirrorBottom), S, fontsize(35pt));
}