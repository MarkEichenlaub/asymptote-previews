...
filldraw(A+(1-0.25,4)--A+(1+0.25,4)--A+(1+0.25,0)--A+(1-0.25,0)--cycle,blue);
...
filldraw(A+(1-0.25,.5)--A+(1+0.25, .5)--A+(1+0.25,0)--A+(1-0.25,0)--cycle,blue);
filldraw(A+(3.8-0.25,0)--A+(3.8+0.25,0)--A+(3.8+0.25,3.5)--A+(3.8-0.25,3.5)--cycle,blue);