//TeXeR source: https://artofproblemsolving.com/texer/kuhplskc
...
draw((0,0)--(0,.4));
draw(shift(0,.5)*scale(.1)*unitcircle);
draw((0,.6)--(0,2));
resistor((0,1),(1,1));
resistor((0,2),(1,2));
draw((1,2)--(1,0)--(0,0));
draw((0,.43)--(0,.57),arrow = Arrow(6));
label("$10\;\mathrm{A}$",(-.1,.5),W);
label("$2\;\mathrm{\Omega}$",(.5,1.05),N);
label("$3\;\mathrm{\Omega}$",(.5,2.05),N);