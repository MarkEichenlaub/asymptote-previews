//TeXeR source: https://artofproblemsolving.com/texer/kdxyyhlx

unitsize(4cm);
path c1 = (0,1)--(0,.5)--(.2,.5)--(.2,0)--(.5,0)--(.5,.5)--(.7,.5)--(.7,1);
path c2 = (.3,1)--(.3,.5)--(.2,.5)--(.2,0)--(.5,0)--(.5,.5)--(.4,.5)--(.4,1);

path w1 = (0,.65)--(0,.5)--(.2,.5)--(.2,0)--(.5,0)--(.5,.5)--(.7,.5)--(.7,.65)--cycle;
path w2 = (.3,.95)--(.3,.5)--(.2,.5)--(.2,0)--(.5,0)--(.5,.5)--(.4,.5)--(.4,.95)--cycle;
