...
draw(BR--top, dashed+red);
draw(TR--bot, dashed+red);

label("low magnification",(0.1*BL+0.9*BR),S);
...
draw(shift(0,ys)*(BR2--top2), dashed+red);
draw(shift(0,ys)*(TR2--bot2), dashed+red);
