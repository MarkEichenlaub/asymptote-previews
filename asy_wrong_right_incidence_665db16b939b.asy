...
//normal angle
draw(rightanglemark((0,1),(0,0),(0,-1),6),dotted);

//real angle of incidence
draw(anglemark((0,1),(0,0),rotate(th)*(0,1),10),deepgreen);
label("\begin{tabular}{c} angle of \\ incidence \\ (usual)\end{tabular}",scale(.3)*rotate(th*.7)*(0,1),N,deepgreen);