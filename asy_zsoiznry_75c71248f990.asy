...
real[] energies = {.85, .15, 0}; //you can make this as many types of energy as you want, but update line 9 as well
string[] energy_types = {"$K$", "$U$", "$\Delta E_{\rm th}$"};
string unit = "J"; //symbol for energy units, delete the J (but leave the quotes) for no units

string title = "Energy Bar Chart";
...
bool show_y_label = false; //whether to write "Energy (J)" or similar on y-axis
