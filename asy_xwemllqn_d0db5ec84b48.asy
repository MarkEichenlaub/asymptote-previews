//TeXeR source: https://artofproblemsolving.com/texer/wlpctirv
size(8cm);
...
real p = 1;  // probability of light passing through sheet
...
// Add label
label("Plastic Wrap", (w/2 + t/2, h), N, fontsize(18pt) + Helvetica());