...
real[] xdata = {2.45, 7.17, 15.66, 20.03, 22.93, 27.55, 33.82, 38.11, 102.7}; 
real x_transform(real x){ 
return sqrt(x); //change to, e.g. "return x^2;" to plot x^2 on the horizontal axis. 
}

real[] ydata = {1.012, 1.12, 1.328, 1.43, 1.478, 1.565, 1.686, 1.742, 2.602}; 
...
real curve(real x){
return .18907*x + 0.60954;  //change to the equation for your curve
}
...
string xAxisLabel = "$\sqrt{m} \, (\mathrm{kg}^{1/2})$"; //for no label, delete the stuff between the quotes
