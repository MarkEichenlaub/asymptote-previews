...
real[] ydata = {1.01, 1.11, 1.33, 1.42, 1.45, 1.55, 1.68, 1.75, 2.62}; 
...
real curve(real x){
return .0157*x + 1.075;  //change to the equation for your curve
}
