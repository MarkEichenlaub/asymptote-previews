//TeXeR source: https://artofproblemsolving.com/texer/uxugbyck
...
draw((100,0)--(100,56)--(0,42)--cycle, deepgreen+linewidth(8pt));
draw((50,21)--(50,49)--(0,42)--cycle, red+linewidth(4pt));

draw((-15,0)--(-15,56),brown+dotted+1bp,Arrows(2mm));
label(rotate(90)*"$56 \;\mathrm{cm}$",(-18,28), UnFill);

draw((115,0)--(115,56),brown+dotted+1bp,Arrows(2mm));
label(rotate(90)*"$56 \;\mathrm{cm}$",(115,28), UnFill);