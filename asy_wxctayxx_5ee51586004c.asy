//TeXeR source: https://artofproblemsolving.com/texer/wxctayxx
...
ship((4,-2),0,"A");
ship((7,0),.5,"G ($2 \;\mathrm{s}$)");
ship((9*.4-2,2),.2,"L ($5 \;\mathrm{s}$)");
label("$4 \;\mathrm{m/s}$",(4.1,2.5),E);
label("$10 \;\mathrm{m/s}$",(10.1,.5),E);
