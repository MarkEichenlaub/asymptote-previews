...
real spring1 = 0.7, spring2 = 1, spring3 = 1.3, cart_l = 0.8, wall_h = 0.6, wheel_r = 0.06, cart_h = 0.3, wheel_pos = 0.2;
...
real arrow_h = 0.8;
draw("$x$", shift(-spring2/2 - cart_l/2, arrow_h*cart_h)*((0.3, 0)--(0, 0)), Arrow(), BeginBar(3));
draw("$x$", shift(spring2/2 + cart_l/2, arrow_h*cart_h)*((0.3, 0)--(0, 0)), Arrow(), BeginBar(3));
...
currentpicture = shift(-0.3, -1)*currentpicture;
