...
real[] energies = {(1-mu)/2, 0, (1+mu)/2}; //you can make this as many types of energy as you want, but update line 9 as well
...
label("$\frac{1-\mu}{2}$",(bar_width+0/num_energies, energies[0]),N );
label("$0$",(bar_width+1/num_energies, energies[1]),N );
label("$\frac{1+\mu}{2}$",(bar_width+2/num_energies, energies[2]),N );
