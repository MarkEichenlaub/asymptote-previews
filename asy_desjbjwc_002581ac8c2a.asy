...
string xAxisLabel = "$a^3 \;\; (\mathrm{au}^3)$";
string yAxisLabel = "$T^2 \;\; (\mathrm{days}^2)$";
...
//axes
real xTickSpacing = 100.0; //must be entered as a decimal
real xSubtickSpacing = 25.0; //set equal to xTickSpacing if you don't want little ticks
real yTickSpacing = 10000000.0;
real ySubtickSpacing = 2500000.0;
