...
bool bigGrid = false; //gridlines for the labeled tick marks
bool smallGrid = false; //gridlines for the smaller subticks
...
draw((0,0)--(xmax,0), blue+linewidth(2pt));
label("barge",(xmax/2,0),N, blue);

draw((0,0)--(xmax,-6), deepgreen+linewidth(2pt));
label("port",(xmax/2,-3),SW, deepgreen);

draw((0,15)--(xmax,9), deepgreen+linewidth(2pt));
label("village",(2/3*xmax,(9*2/3+15*1/3)),NE, deepgreen);

draw((0,0)--(xmax/2,12)--(xmax,0), red+linewidth(2pt));
label("boat",(xmax/3,(9+15)/3),NW, red);

label("0",(0,0),W);
label("45 min", (45,ymin),S);
draw((45,ymin)--(45,ymax), dotted);
label("15 km", (0,15),W);
label("9 km",(xmax,9),E);