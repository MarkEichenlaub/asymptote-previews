...
draw("$F_f$",(1,1.1)--(1,1.42), arrow = Arrow(6), red);

draw("$N$",(1,1.1)--(.6,1.1), arrow = Arrow(6), red);

//draw("$H$",(.5,1.5)--(.8,1.2), arrow = Arrow(6),red);

draw((1,1.1)--(.5,1.5), dotted);

draw((1,1.1)--(.6,1.42), arrow = Arrow(6),red);

draw((.6,1.1)--(.6,1.42), dotted+red);
draw((1,1.42)--(.6,1.42),dotted+red);