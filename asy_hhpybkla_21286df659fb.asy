...
label("$3 \;\mathrm{mi}$",interp(you, (sun.x,you.y),.5), UnFill); 

//Sun vertical
draw((sun.x,you.y)--sun,brown+dotted+1bp,Arrows(2mm));
label("$10 \;\mathrm{mi}$",(sun.x,sun.y/2 + you.y/2), UnFill); 

//airplane horizontal
draw(you--(plane.x,you.y),brown+dotted+1bp,Arrows(2mm));
label("$11 \;\mathrm{mi}$",(you.x/2 + plane.x/2,you.y), UnFill); 

//airplane vertical
draw((plane.x,you.y)--plane,brown+dotted+1bp,Arrows(2mm));
label("$6 \;\mathrm{mi}$",(plane.x,you.y/2 + plane.y/2), UnFill); 
