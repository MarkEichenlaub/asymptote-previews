...
label("$0\;\mathrm{V}$",(0,.25),W);
label("$0\;\mathrm{V}$",(.25,0),S);
label("$0\;\mathrm{V}$",(1.25,0),S);
label("$0\;\mathrm{V}$",(2,.5),E);
label("$0\;\mathrm{V}$",(2,1.5),E);
label("$0\;\mathrm{V}$",(1.85,2),N);
label("$0\;\mathrm{V}$",(1.85,1),N);