...
draw((-2,1)--(2,.5),dashed+red);
draw((2,.5)--(4,.25),dashed+blue);
draw((-2,0)--(2,.5),dashed+red);
draw((2,.5)--(4,.78),dashed+blue);
draw((-2,0)--(-2,1),dashed+red);
draw((3.98,.2)--(3.98,.8),dashed+blue);

draw(shift(4,.78)*rotate(180)*scale(.55)*uparrow());