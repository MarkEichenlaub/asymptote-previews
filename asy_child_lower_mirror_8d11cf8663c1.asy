...
// Child's lowered mirror: top at midpoint between child's eye and top of hat
real childEyeY = childHeight * eyeFraction;
real childHatTop = childHeight + hatHeight;  // = adultHeight
real childMirrorTop = (childEyeY + childHatTop) / 2;
real childMirrorBottom = childMirrorTop - mirrorHeight;  // same size mirror
...
// ============================================================
// LEFT PICTURE: Adult (unchanged from child_mirror_height)
// ============================================================
...
// ============================================================
// RIGHT PICTURE: Child with lowered mirror
// ============================================================
...
drawMirror(mirrorX_R, childMirrorBottom, childMirrorTop);

drawRays(personX_R, childEyeY, mirrorX_R, childMirrorBottom, childMirrorTop, childHatTop);
