//TeXeR source: https://artofproblemsolving.com/texer/haesrcvb
...
label("L",(4,.5),N);
draw(shift(4.2,.3)*((0,0)--(1,0)), arrow = Arrow(6));
label("A",(-1.5,.3));

draw(shift(-4,-2)*((0,0)--(1,0)), arrow = Arrow(6));
label("Alex's Frame",(0,-2.5),S);