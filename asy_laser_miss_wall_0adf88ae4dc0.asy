...
// --- Drawing scale ---
// Horizontal: use a scale factor so the 2.0 m + window are clearly visible
// 1 horizontal unit = 1 m (real scale)
real hScale = 3.0;              // cm per meter horizontally
real wallY  = 8.0;              // compressed vertical height (cm-ish units)
...
// --- Break symbol (to indicate compressed vertical) ---
bool showBreak   = true;
real breakY      = 1.8;         // y-position of break
real breakW      = 0.15;        // half-width of zigzag
real breakH      = 0.25;        // half-height of zigzag
