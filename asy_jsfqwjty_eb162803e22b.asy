//TeXeR source: https://artofproblemsolving.com/texer/jsfqwjty
...
label("$R_1$",(0.95,1.5),W);
label("$R_2$",(2.05,1.5),E);
label("$R_v$",(0.95,.5),W);
label("$R_x$",(2.05,.5),E);
...
draw((1,1)--(1.3,1));
draw(shift(1.5,1)*scale(.2)*unitcircle);
draw((1.7,1)--(2,1));

label("$A$",(1.5,1));

draw((.85,.36)--(1.15,.56),arrow = Arrow(6));