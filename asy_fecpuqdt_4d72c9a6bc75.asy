//TeXeR source: https://artofproblemsolving.com/texer/fecpuqdt
...
draw((0,42)--(100,56), dashed+red);
draw((0,42)--(100,0),dashed+red);
draw((50,49)--(0,42),   arrow = Arrow(6) ,red );
draw((50,21)--(0,42),   arrow = Arrow(6) ,red );
