...
//gravity
draw(shift(box_center)*((0,0)--(0,-.3)),arrow = Arrow(6),blue+linewidth(1.5pt));
label("$mg$",box_center+(0,-.3),S,blue);
...
//draw(arc(box_center,.08,-10,-350), arrow = Arrow(6), deepgreen+linewidth(1.5pt));

draw(shift(box_center)*((.02,.02)--(.1,.1)), arrow = Arrow(6), blue+linewidth(1.5pt));
draw(shift(box_center)*((-.02,-.02)--(-.1,-.1)), arrow = Arrow(6), blue+linewidth(1.5pt));
label("$a$",box_center+(.1,.1),NE,blue);

label("Up/Right Vibrations",(.5,-.1));
...
//draw(arc(box_center,.08,10,350), arrow = Arrow(6), deepgreen+linewidth(1.5pt));
label("Up/Left Vibrations",(.5,-.15));
draw(shift(box_center)*((.02,-.02)--(.1,-.1)), arrow = Arrow(6), blue+linewidth(1.5pt));
draw(shift(box_center)*((-.02,.02)--(-.1,.1)), arrow = Arrow(6), blue+linewidth(1.5pt));
label("$a$",box_center+(-.1,.1),NW,blue);
