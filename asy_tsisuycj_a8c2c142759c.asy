...
filldraw(A+(2.4-0.25,0)--A+(2.4+0.25,0)--A+(2.4+0.25,4)--A+(2.4-0.25,4)--cycle,blue);
filldraw(A+(3.8-0.25,0)--A+(3.8+0.25,0)--A+(3.8+0.25,0)--A+(3.8-0.25,0)--cycle,blue);


pair A = (9,0);

draw(A--A+(6.5,0), EndArrow);
label("Graph 2", A+(3,0), S);
draw(A+(0,1)--A+(6,1),dotted);
draw(A+(0,2)--A+(6,2),dotted);
draw(A+(0,3)--A+(6,3),dotted);
draw(A+(0,4)--A+(6,4),dotted);
...
filldraw(A+(1-0.25,0)--A+(1+0.25,0)--A+(1+0.25,2)--A+(1-0.25,2)--cycle,blue);
filldraw(A+(2.4-0.25,0)--A+(2.4+0.25,0)--A+(2.4+0.25,2)--A+(2.4-0.25,2)--cycle,blue);
filldraw(A+(3.8-0.25,0)--A+(3.8+0.25,0)--A+(3.8+0.25,0)--A+(3.8-0.25,0)--cycle,blue);

pair A = (18,0);

draw(A--A+(6.5,0), EndArrow);
label("Graph 3", A+(3,0), S);
draw(A+(0,1)--A+(6,1),dotted);
draw(A+(0,2)--A+(6,2),dotted);
draw(A+(0,3)--A+(6,3),dotted);
draw(A+(0,4)--A+(6,4),dotted);
