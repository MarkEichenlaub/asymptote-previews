...
draw((1,3)--(1+3/shadow_ratio,0)--(1,0)--cycle, blue+linewidth(2pt));
draw((5,5)--(5+5/shadow_ratio,0)--(5,0)--cycle, blue+linewidth(2pt));

label("Height",(1,3/2),W,blue,UnFill);
label("$\begin{array}{c}\mathrm{Shadow}  \\ \mathrm{Length}\end{array}$",(1 + 1.5/shadow_ratio,0),S,blue);

label("Height",(5,5/2),W,blue,UnFill);
label("$\begin{array}{c}\mathrm{Shadow}  \\ \mathrm{Length}\end{array}$",(5 + 2.5/shadow_ratio,0),S,blue);