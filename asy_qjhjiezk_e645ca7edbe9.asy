...
draw(shift(head)*((0,0)--(0,-g)), arrow = Arrow(6),deepgreen+linewidth(2pt));
label("$g$",head+(0,-g/2),E,deepgreen);
label(rotate(-90)*"adjacent",(head+(.06,-g/2)),E,deepgreen);
...
draw(shift(head)*shift(0,-g)*((0,0)--(-a,0)), arrow = Arrow(6),red+linewidth(1pt));
label("$a$",head+(-a/2,-g),S,red);
